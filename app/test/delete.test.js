...
describe('Delete User API', () => {
  describe('No userId provided validation error', () => {
    ...
    it('Status', done => {
      request.delete(`${url}/delete/${signId}`, {}, (_, response) => {
    ...
    it('Content', done => {
      request.delete(`${url}/delete/${signId}`, {}, (_, response) => {
        ...
        expect(body.errors[0]).to.equal('You have to provide a signId')
        done()
      })
    })
  })

  describe('Invalid signId provided validation error', () => {
    ...
    it('Content', done => {
      request.delete(`${url}/delete/${signId}`, {}, (_, response) => {
        const body = JSON.parse(response.body)
        expect(body.errors[0]).to.equal('Please provide a valid SignId')
        done()
      })
    })
  })
